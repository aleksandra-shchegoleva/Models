...
alpha1(1) = 0.06; %начальное значение питания
x1(1) = 97; %начальное значение жертв
x2(1) = 1; %начальное значение хищников
k = 0.1; %кратность увеличения жертв
...
for n=1:length(M) - 1 
    ...
    alpha1(n + 1) = alpha1(n) + h/6*(z1 + 2*z2 + 2*z3 + z4);
end
