...
%% ИСХОДНЫЕ ДАННЫЕ ХРАНЯТСЯ В ФАЙЛАХ DATAx.MAT, ГДЕ х - НОМЕР РИСУНКА
%% РИСУНКИ 1 И 12 СОСТОЯТ ИЗ НЕСКОЛЬКИХ ГРАФИКОВ, СООТВЕСТВЕННО ПОСЛЕ х СТАВИТСЯ ТИРЕ И  НОМЕР ГРАФИКА НА РИСУНКЕ
%% В НАЗВАНИИ К КАЖДОМУ КОДУ УКАЗАНЫ НОМЕРА РИСУНКОВ ДЛЯ КОТОРЫХ СТРОЯТСЯ ГРАФИКИ
%% В ФУНКЦИИ LOAD УКАЗЫВАЕТ НОМЕР РИСУНКА
